    ...
    <div className="max-w-full p-4 sm:p-6 bg-white flex flex-col gap-8">
      <div className="w-full lg:max-w-md bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6 shadow-sm min-w-[290px]">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-indigo-700 shadow-md hover:shadow-lg hover:cursor-pointer"
          >
            Submit
          </button>
        </form>
